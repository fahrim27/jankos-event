        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-2 mb-md-0">
                <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex py-75" id="account-pill-event" data-toggle="pill" href="#account-vertical-event" aria-expanded="false">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade " id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                 ...
                                 @if ($user->hasRole('Teacher'))
                                <div class="tab-pane fade " id="account-vertical-event" role="tabpanel" aria-labelledby="account-pill-event" aria-expanded="false">
                                    {!! Form::open(['url' => route('setting.updateCategory'), 'method' => 'post']) !!}
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        {!! Form::label('title', 'Kategori Lomba') !!}
                                                        <select name="category_id" class="form-control select2" required>
                                                             @if($selectedcategory != null)
                                                                    <option selected value="{{$selectedcategory->id}}">{{$selectedcategory->name ?? ''}}</option>
                                                                @endif
                                                            @foreach(\App\Category::orderBy('name', 'ASC')
                                                                    ->get() as $vl)
